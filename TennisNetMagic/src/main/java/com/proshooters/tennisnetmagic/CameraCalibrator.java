...
public class CameraCalibrator {
    private static final String TAG = "TennisNetMagic::CameraCalibrator";
    ...
    private void findPattern(Mat grayFrame) {
        // Sample code has method findCirclesGrid, which I don't see in my version of OpenCV, changed to ...Default
